# Mustafah Abdulaziz — research note
...
## Technique and technical limits

The source records establish a contemporary, long-term color-photography project, but do not identify a camera body, lens, focal length, aperture, shutter speed, ISO, capture medium, lighting method, post-production workflow, print process, paper, edition, or print dimensions for these photographs. The ingested display JPEGs have no usable EXIF. The chapter therefore does not infer analogue versus digital capture, printing, or camera settings. Its luminance, edge-density, and palette figures describe only the supplied web renditions.

The working method visible in this selection is not a uniform recipe but a repeated commitment to relation: small figures or objects remain legible because terrain, water, structures, and empty intervals are also kept in the frame. The overlays mark only concrete image features—course edge, tree reflection, truss, case seam, palm rhythm, crowd field, boat, rock, or horizon—and deliberately reject detector proposals when they would turn a tonal break or an overhead view into false perspective.
