# Germaine Krull — source shortlist

Krull's 1928 *Métal* portfolio is a compact argument for treating industrial infrastructure as a photographic subject rather than as background: cranes, iron lattice, wheels, and bridges are cropped and tilted until scale becomes uncertain and functional geometry becomes abstraction. The National Gallery of Victoria identifies *Métal* as a 64-plate portfolio of structures photographed in Amsterdam, Rotterdam, Marseille, Saint-Malo, and Paris; Jeu de Paume places the portfolio and Krull's 1929 *Film und Foto* appearance at the center of her modernist reputation. This unit also keeps two adjacent works—the carnival image and the Peugeot commission—because they show the same high/low and dynamic framing being carried from steel architecture into popular spectacle and commercial photography.

**Rights basis:** Krull died in 1985 and the selected works remain copyrighted. The National Gallery of Art identifies the rightsholder notice for its Krull works as **© Estate Germaine Krull, Museum Folkwang, Essen**. These are therefore not represented as open content. Each file below is a web-sized JPEG directly served on the public work page of Bruce Silverstein, an established photography gallery, and is used under an individually assessed US fair-use rationale for this nonprofit criticism, scholarship, and transformative composition-teaching book. The source record and creator/rightsholder notice are retained; the chapter will credit and link to the source rather than substitute for the gallery record, original print, estate, or a licensed reproduction.

## Shortlist

### 01 — *Untitled (Abstract Industrial Building)* (1925)

- **Why it matters:** A steeply framed industrial facade turns architectural bays into a near-vertical stack of light and shadow—an early, legible route from reportorial subject to abstract plane.
...
- **Why it matters:** The dense metal structure is reduced to interlocking beams and dark voids, making the portfolio's central lesson—industrial description becoming graphic abstraction—available in one frame.
...
- **Why it matters:** Its dark radial machinery, cropped close and set against a pale field, transfers the modernist vocabulary of metalwork to public spectacle and makes a useful counterpoint to the *Métal* plates.
...
- **Why it matters:** A radical upward view converts the Eiffel Tower into a lattice of diagonals and compact dark wedges—the canonical *Métal* strategy at its clearest and most teachable.
...
- **Why it matters:** The commissioned automobile image shows the same forceful close framing and metallic sheen in applied work: the product is organized as a sculptural mass rather than a neutral illustration.
...
- [National Gallery of Victoria, *Metal*](https://www.ngv.vic.gov.au/explore/collection/work/150864/) documents the 64-plate 1928 portfolio, its industrial subjects, and its estate copyright notice.
- [Jeu de Paume's Krull overview](https://jeudepaume.org/mediateque/germaine-krull/) situates *Métal*, *Film und Foto*, and her linked practice of innovative reportage and illustration.
- [National Gallery of Art's Germaine Krull records](https://www.nga.gov/artists/26999-germaine-krull) identify works including *Untitled (The Eiffel Tower)* and record that Krull artist rights must be cleared through the Estate Germaine Krull, Museum Folkwang, Essen. The NGA's direct image service returned 403 to this runner and the Browser surface was unavailable, so these public records were used for verification rather than acquisition.
