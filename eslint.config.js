...
// ESLint 9+ flat config. Lint is advisory in the gate, but it is wired correctly:
// the react-hooks rules (rules-of-hooks, exhaustive-deps) are actually enabled here,
